...
public final class GameConfig {
    ...
    private static GameConfig instance;    // the one instance
    private final Map<String, Object> settings = new LinkedHashMap<>();

    private GameConfig() {          // ← THE line that enforces the pattern
        loadDefaults();
    ...
    private void  loadDefaults() {
        settings.put("playerStartingHp", 50.0);
        ...
        settings.put("maxMonstersPerRoom", 2);
